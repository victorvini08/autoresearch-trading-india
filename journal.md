...
## Iteration 2026-05-17-7d290ea — KEPT

**Hypothesis:** Adding a PIT-safe close-location accumulation term will improve validation Sortino by preferring momentum names whose recent up-move closes near daily highs on traded value, filtering distribution-style advances without changing the fixed-slot construction.

**Change:** I added an OHLCV-based 63-day close-strength accumulation metric, lightly rewarded constructive close location, and vetoed clear distribution while preserving PIT universe gating, biweekly cadence, fixed-slot sizing, sector cap, and order_target_percent-only execution.

**Decision:** KEPT — sortino 3.652 > prev 3.645505465789117, agg_dd 15.1%, catastrophe gate clear, anti-overfit gates passed

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.652368255577813
- validation_folds: 13
- per_fold_sortinos: [5.1914, 0.3163, -0.9846, 5.6849, 9.6958, 6.8286, 5.9485, 5.4646, 2.3561, 0.6891, 2.1069, 1.8128, 2.3703]
- calmar_mean: 7.517746244523797
- hit_rate_mean: 0.542983242247948
- profit_factor_mean: 5.977842637255696
- trade_count_total: 189
- aggregate_max_dd: 0.15130025262259686
- worst_fold_max_dd: 0.12598967743333822
- max_position_frac_peak: 0.06432321564169123
- lower_quartile_fold_calmar: 1.859015131292372
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.646 to 3.652 (+0.007). Aggregate DD was 15.1% versus previous kept 15.1%; negative folds were 1/13; trades=189. Keep compounding on this change, but future iterations should still explain whether the gain came from better return, lower downside, or fewer fragile folds. Decision reason: sortino 3.652 > prev 3.645505465789117, agg_dd 15.1%, catastrophe gate clear, anti-overfit gates passed.

---

## Iteration 2026-05-17-2ad4875 — REVERTED

**Hypothesis:** Adding a PIT-safe six-month range-confirmation term will improve validation Sortino by preferring intermediate momentum names that remain near their 126-day range highs rather than names whose positive trend has already materially decayed.

**Change:** I added a 126-day range-location confirmation metric with a light score reward and a weak-position veto, preserving PIT universe gating, fixed-slot sizing, biweekly cadence, sector cap, and order_target_percent-only execution.

**Decision:** REVERTED — sortino 3.630 did not improve on prev 3.652368255577813

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.6303749397181253
- validation_folds: 13
- per_fold_sortinos: [5.1914, 0.3163, -0.9846, 5.6849, 9.6958, 6.8286, 5.9485, 5.4646, 2.3561, 0.557, 1.9529, 1.5828, 2.6003]
- calmar_mean: 7.429181567091349
- hit_rate_mean: 0.5324614299727422
- profit_factor_mean: 6.014595942427935
- trade_count_total: 189
- aggregate_max_dd: 0.15130025262259686
- worst_fold_max_dd: 0.12598967743333822
- max_position_frac_peak: 0.06432321564169123
...
**Learning:** Sortino changed from 3.652 to 3.630 (-0.022). Aggregate DD was 15.1% versus previous kept 15.1%; negative folds were 1/13; trades=189. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 3.630 did not improve on prev 3.652368255577813.

---

## Iteration 2026-05-17-87db1e3 — KEPT

**Hypothesis:** Adding a PIT-safe recent close-location confirmation term will improve validation Sortino by ensuring the kept 63-day accumulation signal is still active over the most recent month rather than stale.

**Change:** I added a 21-day close-location accumulation check and small score contribution using the existing recent_days parameter, vetoing only clear recent distribution while preserving PIT universe gating, fixed-slot sizing, biweekly cadence, sector cap, and order_target_percent-only execution.

**Decision:** KEPT — sortino 3.797 > prev 3.652368255577813, agg_dd 15.1%, catastrophe gate clear, anti-overfit gates passed

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.7968885204229252
- validation_folds: 13
- per_fold_sortinos: [5.0982, 1.3612, -0.0402, 5.6859, 9.8423, 6.7587, 5.891, 5.4589, 2.3402, 0.6886, 2.0917, 1.8128, 2.3703]
- calmar_mean: 7.671338363091986
- hit_rate_mean: 0.5485885908962831
- profit_factor_mean: 5.91729534269724
- trade_count_total: 189
- aggregate_max_dd: 0.15098963858874526
- worst_fold_max_dd: 0.1257994904233093
- max_position_frac_peak: 0.06421688065510837
- lower_quartile_fold_calmar: 1.859015131292372
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-aa19796 — REVERTED

**Hypothesis:** Adding a PIT-safe recent participation confirmation term will improve validation Sortino by favoring already-qualified momentum names whose traded value has expanded recently, indicating current institutional participation rather than stale price strength.

**Change:** I added a recent-versus-intermediate traded-value participation score using existing windows, with a small ranking contribution and no new parameters or hard concentration changes.

**Decision:** REVERTED — sortino 3.391 did not improve on prev 3.7968885204229252

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.3914874101356505
- validation_folds: 13
- per_fold_sortinos: [1.2904, 1.368, -0.5112, 5.0732, 9.647, 6.6588, 6.0408, 5.4743, 2.6966, 0.7066, 1.8242, 1.2302, 2.5904]
- calmar_mean: 7.283568369568557
- hit_rate_mean: 0.5447103652479932
- profit_factor_mean: 5.544583847938811
- trade_count_total: 194
- aggregate_max_dd: 0.1311755654463121
- worst_fold_max_dd: 0.11345825688859762
- max_position_frac_peak: 0.06154855176057705
- lower_quartile_fold_calmar: 1.8214815198233358
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-476d877 — REVERTED

**Hypothesis:** Replacing the full 126-day momentum score with a PIT-safe pre-recent momentum leg will improve validation Sortino by avoiding names whose rank is driven mainly by the last-month surge while keeping the proven recent accumulation confirmation intact.

**Change:** I changed the main trend contribution to use seasoned_trend from day 126 to day 21 and require it to be positive, preserving all fixed-slot sizing, PIT universe gating, sector cap, and order_target_percent-only execution.

**Decision:** REVERTED — sortino 2.993 did not improve on prev 3.8279484160617105 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = 0.0792 (need ≥ 0.20); sub-periods = [+4.176, +0.331])

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 2.9932162165420055
- validation_folds: 13
- per_fold_sortinos: [2.4941, -0.0849, -1.8659, 5.0092, 9.1361, 6.8761, 7.2297, 6.0952, 2.6984, 0.0732, 0.8971, 0.8241, -0.4705]
- calmar_mean: 5.741923904983531
- hit_rate_mean: 0.5058989276183847
- profit_factor_mean: 4.032007123337937
- trade_count_total: 187
- aggregate_max_dd: 0.13779376173103255
- worst_fold_max_dd: 0.12315695762581394
- max_position_frac_peak: 0.06485913139982442
- lower_quartile_fold_calmar: -0.08466439207097701
- n_negative_folds: 4/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.828 to 2.993 (-0.835). Aggregate DD was 13.8% versus previous kept 12.0%; negative folds were 4/13; trades=187. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 2.993 did not improve on prev 3.8279484160617105 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = 0.0792 (need ≥ 0.20); sub-periods = [+4.176, +0.331]).

---

## Iteration 2026-05-17-e523ae2 — REVERTED

**Hypothesis:** Adding a PIT-safe weak-market participation veto will improve validation Sortino by avoiding momentum names that systematically trade down on higher value during broad-market red days, filtering distribution that is not captured by ordinary accumulation or close-location metrics.

**Change:** I added a market-red-day value-weighted relative-strength check using the existing defensive window, vetoing stocks with materially negative high-participation behavior on weak market days while preserving the kept ranking, fixed-slot sizing, sector cap, PIT universe gate, and order_target_percent-only contract.

**Decision:** REVERTED — sortino 3.777 did not improve on prev 3.8279484160617105

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.776858763651791
- validation_folds: 13
- per_fold_sortinos: [5.0536, 1.2639, -0.0186, 5.8438, 9.8882, 6.7494, 5.7488, 5.4848, 2.7963, 0.9055, 1.9439, 1.0782, 2.3614]
- calmar_mean: 7.793463454397062
- hit_rate_mean: 0.5823824930725384
- profit_factor_mean: 6.472353375401799
- trade_count_total: 187
- aggregate_max_dd: 0.11938870071557603
- worst_fold_max_dd: 0.10609345801773029
- max_position_frac_peak: 0.063563278314807
- lower_quartile_fold_calmar: 1.8293873153813145
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-58587e0 — REVERTED

**Hypothesis:** Adding a PIT-safe lower-tail trend breadth check will improve validation Sortino by rejecting momentum names whose 126-day gain is positive but overly dependent on too few positive trading days, filtering fragile advances without repeating the failed jump-dependency or volatility-normalized variants.

**Change:** I added a fixed-constant up-day participation quality metric over the intermediate window and require a modest positive-day share before scoring, preserving fixed-slot sizing, PIT universe gating, sector cap, and order_target_percent-only execution.

**Decision:** REVERTED — sortino 3.641 did not improve on prev 3.8279484160617105

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.641215118902765
- validation_folds: 13
- per_fold_sortinos: [5.0546, 1.2149, -0.1533, 4.5183, 8.8748, 6.6718, 5.9503, 5.5116, 2.8929, 0.9557, 1.9887, 1.4938, 2.362]
- calmar_mean: 7.482412350549562
- hit_rate_mean: 0.5681523039554714
- profit_factor_mean: 6.042336246091056
- trade_count_total: 188
- aggregate_max_dd: 0.11694222392679739
- worst_fold_max_dd: 0.10479826598970256
- max_position_frac_peak: 0.06233963305495287
- lower_quartile_fold_calmar: 1.9915560130087124
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.828 to 3.641 (-0.187). Aggregate DD was 11.7% versus previous kept 12.0%; negative folds were 1/13; trades=188. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 3.641 did not improve on prev 3.8279484160617105.

---

## Iteration 2026-05-17-12d0d5b — REVERTED

**Hypothesis:** Requiring a broader pool of qualified names before deploying fixed slots will improve validation Sortino by staying in cash during narrow, fragile momentum regimes without adding another stock-level filter.

**Change:** I raised the internal breadth-of-opportunity floor in sector-capped selection, preserving the existing ranking and sizing while only allowing rebalances when enough qualified candidates exist.

**Decision:** REVERTED — sortino 3.808 did not improve on prev 3.8279484160617105

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.807573278378901
- validation_folds: 13
- per_fold_sortinos: [5.0536, 1.2639, -0.1511, 5.6215, 9.9136, 6.8514, 5.854, 5.553, 2.7955, 0.9059, 1.9812, 1.4938, 2.362]
- calmar_mean: 7.792547577811768
- hit_rate_mean: 0.5635505520120905
- profit_factor_mean: 6.187770234930095
- trade_count_total: 190
- aggregate_max_dd: 0.11965472411016383
- worst_fold_max_dd: 0.10661462331536727
- max_position_frac_peak: 0.06391047720540736
- lower_quartile_fold_calmar: 1.862876675930103
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-77bba17 — REVERTED

**Hypothesis:** Switching the biweekly rebalance parity to the alternate Friday cohort will improve validation Sortino by changing entry and exit timing while preserving the kept stock-selection thesis, fixed-slot sizing, PIT universe gate, sector cap, and Dhan-cost-aware cadence.

**Change:** I changed only rebalance_week_parity from 1 to 0 so the strategy keeps the same ranking and construction logic but tests the other biweekly execution schedule.

**Decision:** REVERTED — sortino 2.594 did not improve on prev 3.8279484160617105 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.1539 (need ≥ 0.20); sub-periods = [+4.021, -0.619])

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 2.593548952385655
- validation_folds: 13
- per_fold_sortinos: [4.1958, 0.868, -0.9775, 4.8081, 9.7513, 7.8814, 3.7727, 3.7103, 2.1824, -0.0721, -0.0861, -1.7205, -0.5975]
- calmar_mean: 5.417579471032431
- hit_rate_mean: 0.4734088623794506
- profit_factor_mean: 4.549748149999612
- trade_count_total: 195
- aggregate_max_dd: 0.195959214640526
- worst_fold_max_dd: 0.1178890755290711
- max_position_frac_peak: 0.07122572575694573
- lower_quartile_fold_calmar: -0.4007809117655157
- n_negative_folds: 5/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.828 to 2.594 (-1.234). Aggregate DD was 19.6% versus previous kept 12.0%; negative folds were 5/13; trades=195. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 2.594 did not improve on prev 3.8279484160617105 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.1539 (need ≥ 0.20); sub-periods = [+4.021, -0.619]).

---

## Iteration 2026-05-17-ea8accf — REVERTED

**Hypothesis:** Increasing fixed risk slots from 16 to 18 will improve validation Sortino by reducing single-name downside tails while preserving the kept ranking, PIT universe gate, sector cap, biweekly cadence, and fixed-slot cash behavior.

**Change:** I changed only n_positions from 16 to 18, making the book modestly more diversified without adding a new signal or sizing off selected count.

**Decision:** REVERTED — sortino 3.744 did not improve on prev 3.8279484160617105

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.743970588162724
- validation_folds: 13
- per_fold_sortinos: [4.9314, 1.2957, 0.0398, 5.3505, 9.1681, 6.8035, 5.9095, 5.5485, 2.7912, 0.8782, 1.7607, 1.8899, 2.3046]
- calmar_mean: 6.9429316475139355
- hit_rate_mean: 0.5628109070416764
- profit_factor_mean: 6.336631074197533
- trade_count_total: 187
- aggregate_max_dd: 0.10949446838664588
- worst_fold_max_dd: 0.09494005877295701
- max_position_frac_peak: 0.05582722953935304
- lower_quartile_fold_calmar: 1.7999675530254275
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-fb1ba70 — KEPT

**Hypothesis:** Replacing the hard breadth-of-opportunity floor with a softer rank-depth requirement will improve validation Sortino by preserving the kept strategy's candidate sufficiency check while avoiding unnecessary cash drag in otherwise high-quality but moderately narrow regimes.

**Change:** I reduced the sector-selection breadth floor from max(n_positions + 4, ceil(1.35 * n_positions)) to max(n_positions + 2, ceil(1.20 * n_positions)) so the strategy still refuses thin opportunity sets but does not repeat the overly restrictive reverted throttle.

**Decision:** KEPT — sortino 3.835 > prev 3.8279484160617105, agg_dd 12.0%, catastrophe gate clear, anti-overfit gates passed
...
## Iteration 2026-05-17-802bd97 — REVERTED

**Hypothesis:** Tightening the short-term overextension filter will improve validation Sortino by avoiding otherwise strong momentum names whose last week already consumed too much of the expected swing-trade edge before entry.

**Change:** I lowered the fast-exhaustion tolerance by rejecting names with one-week gains above 8.5%, keeping the existing ranking, PIT universe gate, fixed-slot sizing, sector cap, and biweekly cadence unchanged.

**Decision:** REVERTED — sortino 3.590 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = 0.0591 (need ≥ 0.20); sub-periods = [+5.053, +0.298])

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.590265473484697
- validation_folds: 13
- per_fold_sortinos: [3.7288, 0.835, -0.0056, 5.9081, 9.9552, 8.1684, 8.2366, 5.7711, 2.882, 0.0566, 0.3723, -0.0762, 0.8409]
- calmar_mean: 6.555526755210631
- hit_rate_mean: 0.5865772084812334
- profit_factor_mean: 6.528943377337637
- trade_count_total: 215
- aggregate_max_dd: 0.11015306839998266
- worst_fold_max_dd: 0.1101530683999826
- max_position_frac_peak: 0.0657978799774259
- lower_quartile_fold_calmar: 0.5724992911507065
- n_negative_folds: 3/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.835 to 3.590 (-0.245). Aggregate DD was 11.0% versus previous kept 12.0%; negative folds were 3/13; trades=215. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 3.590 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = 0.0591 (need ≥ 0.20); sub-periods = [+5.053, +0.298]).

---

## Iteration 2026-05-17-81b0c46 — REVERTED

**Hypothesis:** Adding a PIT-safe gap-fade veto will improve validation Sortino by avoiding momentum candidates whose latest close shows distribution after an event-like upside gap, a pattern not captured by the existing close-to-close exhaustion filter.

**Change:** I added a latest-session gap-fade rejection that excludes names opening more than 3.5% above the prior close but finishing below the open, while leaving ranking, fixed-slot sizing, universe gating, sector caps, and rebalance cadence unchanged.

**Decision:** REVERTED — sortino 3.835 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.8348441841595426
- validation_folds: 13
- per_fold_sortinos: [5.0546, 1.2148, -0.0479, 5.9292, 9.9698, 6.7454, 5.8962, 5.5512, 2.7967, 0.9059, 1.9812, 1.4938, 2.362]
- calmar_mean: 7.896466256447999
- hit_rate_mean: 0.5689209546109999
- profit_factor_mean: 6.492066048063169
- trade_count_total: 188
- aggregate_max_dd: 0.11955532408447746
- worst_fold_max_dd: 0.10631762564081036
- max_position_frac_peak: 0.06371803513146512
- lower_quartile_fold_calmar: 1.862876675930103
- n_negative_folds: 1/13
...
## Iteration 2026-05-17-bb126f8 — REVERTED

**Hypothesis:** Adding a PIT-safe market crash-day breadth veto will improve validation Sortino by moving to cash only when the liquid universe shows broad same-day downside pressure, avoiding systemic selloff entries without repeating the slower Nifty-200DMA regime veto.

**Change:** I added a rebalance-day cross-sectional market stress check using same-day returns across the active universe and skip new exposure when the median active return is below -1.2% and fewer than 35% of names are positive, while preserving fixed-slot sizing, sector caps, universe gating, and order_target_percent-only execution.

**Decision:** REVERTED — sortino 3.288 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.287513745938562
- validation_folds: 13
- per_fold_sortinos: [3.3506, -0.8379, -2.7338, 7.5936, 10.9061, 4.7895, 6.0044, 5.5322, 2.7967, 0.9059, 2.0256, 1.7483, 0.6564]
- calmar_mean: 5.358725605022045
- hit_rate_mean: 0.5395402674248829
- profit_factor_mean: 5.517149574908501
- trade_count_total: 183
- aggregate_max_dd: 0.13825165179428245
- worst_fold_max_dd: 0.10631762564081036
- max_position_frac_peak: 0.06371803513146512
- lower_quartile_fold_calmar: 1.8295335350019766
- n_negative_folds: 2/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-82a8bc9 — REVERTED

**Hypothesis:** Replacing the full realized-volatility penalty with downside-only semivolatility will improve validation Sortino by keeping constructive upside trend variability while still avoiding names with poor downside tails.

**Change:** I changed the volatility input used by the score and hard volatility veto from total realized volatility to downside semivolatility over the same lookback, leaving universe gating, fixed-slot sizing, sector caps, cadence, and order_target_percent execution unchanged.

**Decision:** REVERTED — sortino 3.056 did not improve on prev 3.8348443215568286 | catastrophe: gross exposure: max 142.7% > 100% (cash account — leverage error) | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.0037 (need ≥ 0.20); sub-periods = [+4.422, -0.016])

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.056249031501864
- validation_folds: 13
- per_fold_sortinos: [5.6466, 1.1434, -0.2299, 5.2841, 8.8787, 5.5585, 5.2691, 5.4428, 2.8029, -0.0974, 0.2188, -0.9675, 0.7812]
- calmar_mean: 6.681805785635536
- hit_rate_mean: 0.5481987542239983
- profit_factor_mean: 5.122381836838392
- trade_count_total: 183
- aggregate_max_dd: 0.12838980387395763
- worst_fold_max_dd: 0.11541254261721998
- max_position_frac_peak: 0.21897671197360485
- lower_quartile_fold_calmar: 0.157399609044383
- n_negative_folds: 3/13
- risk.passed: False
- risk.violations: ['gross exposure: max 142.7% > 100% (cash account — leverage error)']

**Learning:** Sortino changed from 3.835 to 3.056 (-0.779). Aggregate DD was 12.8% versus previous kept 12.0%; negative folds were 3/13; trades=183. Do not reuse this exact setup: it failed the catastrophe gate, so the result is not a usable edge even if the hypothesis was economically plausible. Decision reason: sortino 3.056 did not improve on prev 3.8348443215568286 | catastrophe: gross exposure: max 142.7% > 100% (cash account — leverage error) | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.0037 (need ≥ 0.20); sub-periods = [+4.422, -0.016]).

---

## Iteration 2026-05-17-2c0b104 — REVERTED

**Hypothesis:** Adding a PIT-safe two-sided relative participation score will improve validation Sortino by favoring momentum names that outperform the active universe on both up-tape and down-tape days, not just during weak-market sessions.

**Change:** I added a clipped stock-level participation relative-strength term computed from the existing active-universe median return series and included it in ranking while leaving universe gating, fixed-slot sizing, sector caps, and rebalance cadence unchanged.

**Decision:** REVERTED — sortino 3.519 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.5191429342822365
- validation_folds: 13
- per_fold_sortinos: [1.2874, 1.1946, 0.0212, 5.9003, 9.9461, 6.6728, 5.8962, 5.5512, 2.7967, 0.7692, 1.8576, 1.4995, 2.3562]
- calmar_mean: 7.671788906043802
- hit_rate_mean: 0.5602814041162457
- profit_factor_mean: 6.328901662558451
- trade_count_total: 192
- aggregate_max_dd: 0.11955532408447754
- worst_fold_max_dd: 0.10631762564081036
- max_position_frac_peak: 0.06371803513146512
- lower_quartile_fold_calmar: 1.869104924088254
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.835 to 3.519 (-0.316). Aggregate DD was 12.0% versus previous kept 12.0%; negative folds were 1/13; trades=192. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 3.519 did not improve on prev 3.8348443215568286.

---

## Iteration 2026-05-17-da1de51 — REVERTED

**Hypothesis:** Adding a PIT-safe recent reversal recovery requirement will improve validation Sortino by avoiding momentum names that are still below their short-term pre-shock level while preserving the kept trend and accumulation thesis.

**Change:** I added a 10-day recovery check that rejects candidates whose current close has not recovered above the close from two weeks ago, filtering unresolved short-term weakness without changing sizing, cadence, universe gating, or sector caps.

**Decision:** REVERTED — sortino 2.354 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.0066 (need ≥ 0.20); sub-periods = [+3.410, -0.023])

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 2.353510988799515
- validation_folds: 13
- per_fold_sortinos: [5.1399, -1.0888, -3.7517, 4.9585, 9.5958, 4.1154, 3.7296, 5.0921, 2.8955, 0.8267, 1.6901, -1.6515, -0.9559]
- calmar_mean: 3.784338634332518
- hit_rate_mean: 0.4626025507150154
- profit_factor_mean: 3.184622589768353
- trade_count_total: 224
- aggregate_max_dd: 0.1687853758420187
- worst_fold_max_dd: 0.10074507248786467
- max_position_frac_peak: 0.06362377217612697
- lower_quartile_fold_calmar: -0.629777498858417
- n_negative_folds: 4/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.835 to 2.354 (-1.481). Aggregate DD was 16.9% versus previous kept 12.0%; negative folds were 4/13; trades=224. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 2.354 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.0066 (need ≥ 0.20); sub-periods = [+3.410, -0.023]).

---

## Iteration 2026-05-17-252f946 — REVERTED

**Hypothesis:** Adding a PIT-safe traded-value sponsorship rank term will improve validation Sortino by favoring momentum names whose recent liquidity participation is expanding rather than fading, without changing exposure, cadence, sector caps, or universe gating.

**Change:** I added a 21-day versus prior-42-day traded-value support score and included it as a small ranking-only bonus so durable accumulation can break ties among otherwise qualified momentum candidates.

**Decision:** REVERTED — sortino 3.275 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.2750165451443394
- validation_folds: 13
- per_fold_sortinos: [1.4017, 1.3295, -0.6206, 5.0269, 9.754, 6.5793, 5.4456, 5.2123, 2.861, 0.8117, 1.6737, 0.6787, 2.4214]
- calmar_mean: 7.19861534637399
- hit_rate_mean: 0.5759893010458621
- profit_factor_mean: 5.94247977754521
- trade_count_total: 194
- aggregate_max_dd: 0.1165408577312399
- worst_fold_max_dd: 0.1046105003476288
- max_position_frac_peak: 0.06502731114104829
- lower_quartile_fold_calmar: 1.6599180517599696
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []

**Learning:** Sortino changed from 3.835 to 3.275 (-0.560). Aggregate DD was 11.7% versus previous kept 12.0%; negative folds were 1/13; trades=194. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 3.275 did not improve on prev 3.8348443215568286.

---

## Iteration 2026-05-17-ea54ca8 — REVERTED

**Hypothesis:** Adding a PIT-safe stale-breakout penalty will improve validation Sortino by favoring momentum names whose intermediate trend is still making recent highs rather than drifting below an older peak.

**Change:** I added a 63-day days-since-high measure, vetoed very stale intermediate highs, and applied a small ranking penalty so unresolved post-peak momentum candidates are demoted without changing sizing, cadence, PIT universe gating, or sector caps.

**Decision:** REVERTED — sortino 3.271 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.271100213960317
- validation_folds: 13
- per_fold_sortinos: [3.2338, 1.237, 0.3669, 4.2031, 7.8284, 6.8562, 5.6097, 5.723, 2.8514, -0.4607, 0.5218, 1.8111, 2.7425]
- calmar_mean: 7.460757417020115
- hit_rate_mean: 0.5656655310501464
- profit_factor_mean: 10.066472018275183
- trade_count_total: 122
- aggregate_max_dd: 0.16169885248106403
- worst_fold_max_dd: 0.12613284468364613
- max_position_frac_peak: 0.06260743977985428
- lower_quartile_fold_calmar: 1.5531803502772763
- n_negative_folds: 1/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-7935198 — REVERTED

**Hypothesis:** Adding a PIT-safe volatility contraction confirmation will improve validation Sortino by favoring momentum candidates whose recent realized volatility has compressed versus their intermediate volatility, indicating cleaner trend continuation without changing exposure, cadence, sector caps, or universe gating.

**Change:** I added a recent-versus-intermediate volatility contraction score to the existing ranking, with a veto on severe recent volatility expansion, so noisy momentum names are demoted while stable trends remain eligible.

**Decision:** REVERTED — sortino 3.630 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.62995805726263
- validation_folds: 13
- per_fold_sortinos: [5.1695, 1.4234, 0.1214, 5.0284, 8.4257, 6.3948, 6.0593, 5.7563, 2.6267, 0.777, 1.7767, 1.0439, 2.5866]
- calmar_mean: 7.698835113172927
- hit_rate_mean: 0.525074925074925
- profit_factor_mean: 7.122149434502405
- trade_count_total: 183
- aggregate_max_dd: 0.12766028415067354
- worst_fold_max_dd: 0.10786329330108879
- max_position_frac_peak: 0.0649557497450998
- lower_quartile_fold_calmar: 1.84783323586835
- n_negative_folds: 0/13
- risk.passed: True
- risk.violations: []
...
## Iteration 2026-05-17-fe553f5 — REVERTED

**Hypothesis:** Adding a PIT-safe winner-retention buffer will improve validation Sortino by reducing unnecessary sells of still-healthy existing winners while preserving the fixed-slot sizing, universe gate, and sector cap.

**Change:** I changed selection to give currently held names that still pass the existing score filters a modest rank-depth retention path before filling remaining slots from the fresh ranked list, aiming to reduce churn without adding exposure concentration.
...
## Iteration 2026-05-17-73b1025 — REVERTED

**Hypothesis:** Shifting the biweekly rebalance schedule from odd ISO Fridays to even ISO Fridays will improve validation Sortino by avoiding a timing-specific entry cohort while preserving the proven ranking, risk slots, universe gate, and sector cap.

**Change:** I changed only rebalance_week_parity from 1 to 0 so the same fixed-slot momentum-quality book trades on the alternate biweekly Friday schedule without adding parameters or altering signal construction.

**Decision:** REVERTED — sortino 2.594 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.1539 (need ≥ 0.20); sub-periods = [+4.021, -0.619])
...
**Learning:** Sortino changed from 3.835 to 2.594 (-1.241). Aggregate DD was 19.6% versus previous kept 12.0%; negative folds were 5/13; trades=195. Do not repeat this exact idea without a materially different mechanism; the keep gate rejected it for the stated reason. Decision reason: sortino 2.594 did not improve on prev 3.8348443215568286 | anti-overfit FAILED: sub_period_stationarity(signed min/max Sortino ratio across 2 sub-periods = -0.1539 (need ≥ 0.20); sub-periods = [+4.021, -0.619]).

---

## Iteration 2026-05-17-c584022 — REVERTED

**Hypothesis:** Tightening the sector concentration cap from 25% to 20% will improve validation Sortino by reducing shared sector drawdown risk while preserving the existing proven PIT-safe ranking and fixed-slot sizing logic.

**Change:** I changed only the default sector_cap from 0.25 to 0.20 so a 16-slot book can hold at most three names per sector instead of four, leaving signal construction, cadence, universe gating, and order_target_percent sizing unchanged.

**Decision:** REVERTED — sortino 3.678 did not improve on prev 3.8348443215568286

**Result:**
- evaluator_version: 2026-05-16-univfloor
- validation_sortino_mean: 3.6779436803374845
- validation_folds: 13
- per_fold_sortinos: [4.2652, 1.1845, 0.2547, 5.7404, 9.4863, 6.8901, 5.8832, 5.8164, 2.8349, 0.5773, 1.6359, 1.1504, 2.0941]
- calmar_mean: 6.879932168971584
- hit_rate_mean: 0.5506694160540313
- profit_factor_mean: 6.095493422642719
- trade_count_total: 141
- aggregate_max_dd: 0.12237918948290531
- worst_fold_max_dd: 0.10286190031545156
- max_position_frac_peak: 0.06127552208061263
- lower_quartile_fold_calmar: 1.395097941451984
- n_negative_folds: 0/13
- risk.passed: True
- risk.violations: []
